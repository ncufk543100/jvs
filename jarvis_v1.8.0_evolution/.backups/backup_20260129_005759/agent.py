...
- 例如：self_modify_write 必须指定 {"filename": "agent.py", "content": "具体代码"}
- 例如：read_file 必须指定 {"path": "/home/ubuntu/jarvis/agent.py"}
- 例如：scan_files 必须指定 {"path": "/home/ubuntu/jarvis"}
...
{{
    ...
    "steps": [
        {{"tool": "工具名", "params": {{"具体参数名": "具体参数值"}}, "description": "步骤描述"}}
    ]
}}
"""
